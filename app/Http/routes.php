...
Route::group(['middleware' => ['auth','admin']], function () {
  ...
  Route::get('panel/finanzas/graficos/cierredecaja','FinanzasController@cierredecaja');
...
Route::group(['middleware' => ['auth','barra']],function(){
  ...
  Route::get('panelbarra/mesa/borrar/{producto}/{mesa}','BarraController@borrarproductomes');
