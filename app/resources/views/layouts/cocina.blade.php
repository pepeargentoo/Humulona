  ...
  <aside class="main-sidebar" style="background:black;">
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree" style="font-weight: bold; color: white !important;text-transform: uppercase;font-size: 15px;">
        <li><a href="{{url('panelcocina')}}"><i class="fa fa-briefcase"></i><span>General</span></a></li>
        <li><a href="{{url('panelcocina/pedidos')}}"><i class="fa fa-bullhorn"></i><span>Pedidos</span></a></li>
        <li><a href="{{url('panelcocina/salir')}}"><i class="fa fa-sign-out" aria-hidden="true"></i><span>Salir</span></a></li>
        </ul>
    </section>
  </aside>
