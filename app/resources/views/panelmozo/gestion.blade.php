...
<div class="row">
  <div class="col-lg-3 col-xs-6">
    <div class="small-box bg-maroon" style="background: #42795b !important;border: 1px solid;border-radius: 10px;">
      ...
      <a href="{{url('panelmozo/mesas')}}" class="small-box-footer">VER <i class="fa fa-arrow-circle-right"></i></a>
    </div>
  </div>
  <div class="col-lg-3 col-xs-6">
    <div class="small-box bg-maroon" style="background: #42795b !important;border: 1px solid;border-radius: 10px;">
      ...
      <a href="{{url('panelmozo/salir')}}" class="small-box-footer">SALIR <i class="fa fa-arrow-circle-right"></i></a>
    </div>
  </div>
</div>
</section>
