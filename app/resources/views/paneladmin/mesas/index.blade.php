    ...
    <div class="col-xs-12">
      <div class="box fondo" >
        <div class="box-header">
          <h2 class="box-title" >Listado de Mesas</h2>
          <a class=" btn btn-primary btncumtome"  href="{{url('panel/mesas/crear')}}">
            <i class="fa fa-plus"></i>MESA
          </a>
        </div>
        <div class="box-body">
          ...
          <tbody>
            ...
            <td>
              <a href="{{url('panel/mesas/edit',[$c->id])}}">
