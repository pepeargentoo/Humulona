    ...
    <div class="col-xs-12">
      <div class="box" style="background: #407759;border-radius: 10px;border: 2px solid white;">
        <div class="box-header">
          <h2 class="box-title" style="color: white;font-size: 18px;font-weight: bold;text-transform: uppercase;">Listado de Proveedores</h2>
          <a class="btn btn-primary" style="float: right;color: white;background: #294837;font-weight: bold;border: 1px solid;font-size: 15px;text-align: center;text-transform: uppercase;" href="{{url('panel/proveedores/crear')}}">
        ...
        <div class="box-body">
          ...
          <tbody>
            ...
            <tr>
            <td  style="width:80%;">
              <p style="margin: 0px;"><span style="font-weight: bold;">Razon Social: </span>{{$c->razonsocial}}</p>
            ...
            <td>
              <a href="{{url('panel/proveedores/edit',[$c->id])}}">
...
$('.borrarcliente').click(function(e){
  ...
  url = "{{url('panel/proveedores/delete')}}"+'/'+id
