    ...
    <div class="col-xs-12">
      <div class="box fondo" >
        <div class="box-header">
          <h2 class="box-title" >Listado de DISTRIBUCIONes</h2>
          <a class=" btn btn-primary btncumtome"  href="{{url('panel/asignacion/crear')}}">
            <i class="fa fa-plus"></i>DISTRIBUCION
          </a>
        </div>
        <div class="box-body">
          ...
          <tbody>
            @foreach($districucion as $c)
            <tr>
            <td  style="width:80%;">
              <p style="margin: 0px;"><span style="font-weight: bold;">MOZO: </span>{{$c->nombremozo}}<br>
                <span style="font-weight: bold;">MESA: </span>{{$c->nombremesa}}
              </p>
          </td>
            <td>
              <a href="{{url('panel/asignacion/editar',[$c->id])}}">
...
$('.borrarcliente').click(function(e){
  ...
  url = "{{url('panel/asignacion/borrar')}}"+'/'+id
  ...
  swalWithBootstrapButtons.fire({
    title: 'Borrar Mesa',
    text: "Esta seguro que desea borrar esta mesa",
    type: 'warning',
