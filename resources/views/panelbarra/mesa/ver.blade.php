  ...
  <div class="col-xs-12">
    <div class="box fondo" >
      <div class="box-header fondohear" >
        ...
        <h3 style="font-weight: bold;text-transform: uppercase;color: white;">{{$estadiaedit->nombremozo}}</h3>
      </div>
      <div class="box-body">
        ...
        <table id="myTable" class="table table-bordered table-hover">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{$p->nombre}}</td>
              <td style="width:10%;">${{$p->monto}}</td>
              <td style="width:10%;">
                <a href="{{url('/panelbarra/mesa/borrar',[$p->id,$estadiaedit->idmesa])}}" class="borrarcliente" data-id="{{$p->id}}">
        ...
        @endif
        <a class=" btn btn-primary btnctm"  href="{{url('panelbarra/mesas')}}">ATRAS</a>
      </div>
    </div>
  </div>
</section>
