  ...
  <aside class="main-sidebar" style="background:black;">
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree" style="font-weight: bold; color: white !important;text-transform: uppercase;font-size: 15px;">
        <li><a href="{{url('panelbarra')}}"><i class="fa fa-briefcase"></i><span>General</span></a></li>
        <li><a href="{{url('panelbarra/cerrarcaja')}}"><i class="fa fa-gift"></i><span>Cerrar Caja</span></a></li>
        <li><a href="{{url('panelbarra/mesas')}}"><i class="fa fa-cutlery"></i><span>Mesas</span></a></li>
        <li><a href="{{url('panelmozo/salir')}}"><i class="fa fa-sign-out" aria-hidden="true"></i><span>Salir</span></a></li>
        </ul>
    </section>
  </aside>
