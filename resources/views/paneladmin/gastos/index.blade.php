    ...
    <div class="col-xs-12">
      <div class="box fondo" >
        <div class="box-header">
          ...
          <a class="btn btn-primary btncumtome" href="{{url('panel/gastos/crear')}}">
        ...
        <div class="box-body">
          ...
          <tbody>
            ...
            <tr>
            <td  style="width:80%;">
              <p style="margin: 0px;"><span style="font-weight: bold;">Tipo: </span>{{$c->tipo}}</p>
            ...
            <td>
              <a href="{{url('panel/gastos/editar',[$c->id])}}">
...
$('.borrarcliente').click(function(e){
  ...
  url = "{{url('panel/gastos/borrar')}}"+'/'+id
  ...
  swalWithBootstrapButtons.fire({
    ...
    text: "Esta seguro que desea borrar este gasto",
    type: 'warning',
