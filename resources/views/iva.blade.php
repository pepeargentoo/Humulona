<html style="width: 52mm;">
	...
	<div id="contenido">
		...
		<table style="text-transform: uppercase;font-size: 13px;text-align: center">
			...
			font-weight: bold;">Cant</td>
				<td style="font-weight: bold;font-size: 16px;
			font-weight: bold;">ART</td>
				<td style="font-weight: bold;font-size: 16px;
			font-weight: bold;">$</td>
			</tr>
			...
			<tr>
				<td style="font-weight: bold;font-size: 16px;
			font-weight: bold;">{{$finproducto['cantidad'][$i]}}</td>
				<td style="font-weight: bold;font-size: 16px;
			font-weight: bold;">{{$finproducto['producto'][$i]}}</td>
				<td style="font-weight: bold;font-size: 16px;
			font-weight: bold;">{{$finproducto['precio'][$i]}}</td>
			</tr>
			@endfor
		</table>
		<p>TOTAL $: {{$total}}</p>
